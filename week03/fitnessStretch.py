...
def main ():
    ...
    weight = float(input("Enter your weight in British stones: "))
    height = float(input("Enter your height in US inches: "))

    #calculate
    age = compute_age(birth_date)
    weight_in_kg = kg_from_stone(weight)
    height_in_cm = cm_from_in(height) / 100
    ...
    print(f"Height (m): {height_in_cm:.1f}")
