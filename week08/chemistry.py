...
def main():
    ...
    forumla = input("Enter the molecular formula of the sample: ")
    ...
    symbol_list = parse_formula(forumla, periodic_table)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for value in symbol_quantity_list:
        symbol_key = value[SYMBOL]
        quantity = int(value[QUANTITY])
    #   Get the atomic mass for the symbol.
        symbol = periodic_table_dict[symbol_key]
        atomic_mass = symbol[ATOMIC_MASS_INDEX]
