...
def main():
    try:
        ...
        print("You entered a text that is not an integer. Please")
        print("run the program again and enter an integer.")

def get_float(message, low_end, high_end):
    number = None
    while number == None:
        try: 
            ...
            if number < low_end:
                ...
                print(f"Please enter a differnt number.")
                number = None
            elif number > high_end:
